 ...
 */
final class Version20200923060845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, car_model_id INT DEFAULT NULL, garage_id INT DEFAULT NULL, fuel_type_id INT DEFAULT NULL, reference VARCHAR(8) NOT NULL, price DOUBLE PRECISION NOT NULL, description LONGTEXT NOT NULL, mileage INT NOT NULL, release_year DATE NOT NULL, publication_date DATE NOT NULL, picture VARCHAR(255) DEFAULT NULL, INDEX IDX_54F1F40BF64382E3 (car_model_id), INDEX IDX_54F1F40BC4FFF555 (garage_id), INDEX IDX_54F1F40B6A70FE35 (fuel_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
